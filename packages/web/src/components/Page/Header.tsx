        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center md:justify-between py-4">
            ...
            <div className="w-1/4 md:w-auto md:flex text-right">
              <div className="flex justify-center pr-6" style={{height: '36px'}}>
        ...
        <div className="container mx-auto px-4">
          <div className="md:flex">
            <div className="flex -mb-px mr-8">
              <Link href="/todos">
                <a className="no-underline text-white opacity-50 md:text-purple-800 md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-grey-dark">
            ...
            <div className="flex -mb-px mr-8">
              <Link href="/dashboard">
                <a
                  href="#"
                  className="no-underline text-white md:text-purple-800 flex items-center py-4 border-b border-blue-dark"
                >
                  <svg className="h-6 w-6 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                      fillRule="evenodd"
            ...
            <div className="flex -mb-px justify-end flex-auto">
